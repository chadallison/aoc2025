...
parse_targets = function(line) {
  target_str = str_extract(line, "\\{[^}]*\\}") |>
    str_remove_all("[{}]")
  
  as.numeric(str_split(target_str, ",")[[1]])
}
...
gf2_nullspace = function(A) {
  ...
  free_cols = setdiff(1:n, pivots[pivots > 0])
...
sol = sum(map_dbl(input, fewest_presses_part2))
